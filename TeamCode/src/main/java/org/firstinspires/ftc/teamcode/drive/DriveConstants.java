...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID =
        new PIDFCoefficients(24.0, 0, 3.0, 12.8);
        //new PIDFCoefficients(14.4, 0, 0.4, 13.4);
    ...
    public static double TRACK_WIDTH = 16.4; // in - tuned in dash
     ...
     * empirically tuned.
     */
    public static double kV = 0.01582;
    public static double kA = 0.002;
    public static double kStatic = 0.07448;
    ...
    public static double MAX_VEL = 50.0; //RR tune  maxVel 59.96
